                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-9">
                                ...
                                @if (!$isOpen)
                                    <button style="" class="btn btn-secondary btn-lg" id="blockOrderButton" disabled>
                                        <i class="fas fa-shopping-cart me-2"></i>لا يمكنك الطلب , المطعم مغلق !
                                    </button>

                                    {{-- İsteğe bağlı: Açılış saatini göster --}}
                                    <div class="mt-2 text-muted small">
                                        <i class="fas fa-clock me-1"></i>
                                        المطعم يفتح الساعة
                                        {{ \Carbon\Carbon::createFromTimeString($restaurant->opening_time)->format('H:i') }}
                                    </div>
                                @else
                                    ...
                                    {{-- İsteğe bağlı: Kapanış saatini göster --}}
                                    <div class="mt-2 text-muted small">
                                        <i class="fas fa-clock me-1"></i>
                                        المطعم يغلق الساعة
                                        {{ \Carbon\Carbon::createFromTimeString($restaurant->closing_time)->format('H:i') }}
                                    </div>
                                @endif
                            </div>
                        </div>
                                            ...
                                            <div class="card product-card h-100">
                                                <div class="card-body">
                                                    <div class="d-flex justify-content-between align-items-start mb-2">
                                                        ...
                                                        <span
                                                            class="text-red-primary fw-bold">{{ $product->formatted_price }}</span>
                                                    </div>
                                                    ...
                                                    <div class="product-meta">
                                                        <small class="text-muted">
                                                            <i class="fas fa-clock me-1"></i>تحضير:
